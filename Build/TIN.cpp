...
/*
	...
	@Function return value: 一个点和线段两端的端点形成的两条线的夹角，也就是一点到基边的张角
*/
...
/*
	...
	@Function return value:返回最大张角对应的点
*/
...
/*
	...
	@Function return value: 判断点是在三角形左侧还是三角形右侧
*/
...
/*
	...
	@Function param: void
	@Function return value:使用扩张生长法-构建TIN网络
*/
void TIN::createTin() {
	/*
		第一步：在数据点中任取一点A，并寻找距离此点最近的点B，两者相连形成基线AB，利用三角形剖分准则，寻找第三点C，形成第一个Delaunay三角形ABC

		第二步：以初始三角形的三条边为初始基线，利用张角最大原则，寻找能与该三条初始基线形成Delaunay三角形的D、E、F点
